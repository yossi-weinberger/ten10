...
**תאריך:** 18.9.2026 (ז' בתשרי תשפ"ז) · **גרסת אפליקציה:** 0.7.5 · **סטטוס ביצוע (23.9.2026):** P1–P4 ו-0a הושלמו ואומתו ב-[Draft PR #424](https://github.com/yossi-weinberger/ten10/pull/424): CI ירוק בשני אזורי זמן, testing מבודד, Preview ירוק, פרוד נפרס רק מ-`main`, ו-410 בדיקות מגנות על התנהגות התאריכים.
