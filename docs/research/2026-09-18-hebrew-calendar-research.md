...
| **P5. baseline — הופרד** | Dump/squash ו-`migration repair` בפרוד הם שינוי תשתית מסוכן שאינו מעורבב ב-PR #424. יבוצע ב-worktree וב-PR תשתית נפרד, עם rehearsal על clone. testing persistent מאפשר להשלים את הפיצ׳ר בבטחה בינתיים | PR תשתית נפרד | נדחה במכוון | אחרי פיצ׳ר |
