...
**תאריך:** 18.9.2026 (ז' בתשרי תשפ"ז) · **גרסת אפליקציה:** 0.7.5 · **סטטוס ביצוע (23.9.2026):** P1–P4, 0a–0b ושלבים 1–5 הושלמו ואומתו ב-[Draft PR #424](https://github.com/yossi-weinberger/ten10/pull/424): CI ירוק בשני אזורי זמן, testing מבודד, Preview מחובר ישירות ל-testing, Temporal parity עבר ב-Vite וב-Deno, 522 בדיקות TS ו-44 בדיקות Rust ירוקות.
