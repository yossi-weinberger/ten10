    ...
    (set, get) => ({
      ...
      addIncome: (income) => {
        set((state) => {
          ...
          const additionalRequired = income.isChomesh ? income.amount * 0.2 : income.amount * 0.1;
          return {
            incomes: newIncomes,
      ...
      addDonation: (donation) => {
        set((state) => {
          ...
          return {
            ...
            requiredDonation: Math.max(0, state.requiredDonation - donation.amount)
          };
        });
      },
      ...
      removeIncome: (id) => {
        set((state) => {
          ...
          const reducedRequired = income.isChomesh ? income.amount * 0.2 : income.amount * 0.1;
          return {
            incomes: state.incomes.filter(i => i.id !== id),
            requiredDonation: Math.max(0, state.requiredDonation - reducedRequired)
          };
        });
      },
      ...
      updateIncome: (id, updatedIncome) => {
        set((state) => {
          ...
          const oldRequired = oldIncome.isChomesh ? oldIncome.amount * 0.2 : oldIncome.amount * 0.1;
          const newRequired = (updatedIncome.isChomesh ?? oldIncome.isChomesh) 
          ...
          return {
            ...
            requiredDonation: state.requiredDonation - oldRequired + newRequired
          };
        });
      },
      ...
      updateDonation: (id, updatedDonation) => {
        set((state) => {
          ...
          const amountDiff = (updatedDonation.amount ?? oldDonation.amount) - oldDonation.amount;
