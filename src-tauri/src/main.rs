...
use commands::insights_commands::{
    ...
    get_desktop_category_breakdown, get_desktop_daily_heatmap,
    get_desktop_donation_recipients_breakdown, get_desktop_payment_method_breakdown,
    get_desktop_recurring_vs_onetime,
};
use commands::platform_commands::{copy_to_clipboard, get_platform_info};
...
use commands::transaction_commands::{
    add_transaction, bulk_delete_transactions_handler, bulk_update_transactions_handler,
    delete_transaction_handler, export_transactions_handler, get_distinct_categories,
    get_distinct_payment_methods, get_filtered_transactions_handler, get_last_known_rate,
