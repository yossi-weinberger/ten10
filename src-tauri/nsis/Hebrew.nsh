# Tauri NSIS custom strings for Hebrew (LANG_HEBREW)
# Ensures "Already Installed" and related installer UI show in Hebrew when user selects Hebrew.
...
LangString webview2AbortError ${LANG_HEBREW} "התקנת WebView2 נכשלה! היישום אינו יכול לפעול בלי זה. נסה להפעיל את ההתקנה שוב."
