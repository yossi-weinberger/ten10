-- Fix donation recipients breakdown: group by description (not recipient)
-- Users rarely fill the "recipient" field; description is more meaningful.
-- Grouping by COALESCE(description, recipient, 'other') shows distinct donation purposes.
